...
class Widget(QWidget,Ui_Widget):
    def __init__(self):
        ...
        treeitem1.setText(0,"34")
        treeitem1.setText(1,"issar")
        
        treeitem2=QTreeWidgetItem(self.treeWidget)
        treeitem2.setText(0,"65")
        treeitem2.setText(1,"sharma")
        
        # this is a floating item
        treeitem3=QTreeWidgetItem()
        treeitem3.setText(0,"94")
        treeitem3.setText(1,"sinha")
        
        treeitem4=QTreeWidgetItem()
        treeitem4.setText(0,"84")
        treeitem4.setText(1,"kumar")
