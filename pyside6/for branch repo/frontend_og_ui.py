...
################################################################################
## Form generated from reading UI file 'frontend_ogyzYIZb.ui'
##
...
"font-size: 16px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_20.setText(QCoreApplication.translate("Form", u"ROBOT PROPERTIES AND ITS CONSTRAINS", None))
        self.label_7.setText(QCoreApplication.translate("Form", u"Below are the Features provided to add to the above panel", None))
        self.pushButton_5.setText(QCoreApplication.translate("Form", u"Add Another SBC to Robot", None))
        self.pushButton_6.setText(QCoreApplication.translate("Form", u"Add MCU to SBC", None))
        self.pushButton_7.setText(QCoreApplication.translate("Form", u"Add MCU to Another MCU", None))
        self.label.setText(QCoreApplication.translate("Form", u"NYATVA STUDIO - VAYUT Creations", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"minimize", None))
        self.pushButton_2.setText(QCoreApplication.translate("Form", u"restore down", None))
        self.pushButton_3.setText(QCoreApplication.translate("Form", u"close", None))
        self.label_18.setText(QCoreApplication.translate("Form", u"WELCOME  TO NYATVA STUDIOS !", None))
        self.label_19.setText(QCoreApplication.translate("Form", u"<html><head/><body><p>here WE WOULD BE WRITING ABOUT NYATVA STUDIO - .............................................................. </p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p><br/></p><p>........</p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"Adding a SBC To - ROBOT", None))
        ...
        self.label_8.setText(QCoreApplication.translate("Form", u"Adding a MCU To - SBC", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"## Parent SBC    :", None))
        self.label_10.setText(QCoreApplication.translate("Form", u"# MCU Comms       :", None))
        self.label_11.setText(QCoreApplication.translate("Form", u"# MCU Actuators    :", None))
        self.label_12.setText(QCoreApplication.translate("Form", u"# MCU Sensors        :", None))
        self.pushButton_8.setText(QCoreApplication.translate("Form", u"ADD NEW MCU", None))
        self.label_13.setText(QCoreApplication.translate("Form", u"Adding a MCU To -Another MCU", None))
        self.label_14.setText(QCoreApplication.translate("Form", u"## Parent MCU    :", None))
        self.label_15.setText(QCoreApplication.translate("Form", u"# MCU Comms       :", None))
        self.label_16.setText(QCoreApplication.translate("Form", u"# MCU Actuators    :", None))
        self.label_17.setText(QCoreApplication.translate("Form", u"# MCU Sensors        :", None))
        self.pushButton_9.setText(QCoreApplication.translate("Form", u"ADD NEW MCU", None))
    # retranslateUi
